          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Peliculas / Usuarios</h3>
                </div>
...
<div class="col-lg-12">
              ...
              <div class="nav-wrapper">
                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><i class="ni ni-single-02 mr-2"></i>Participantes</a>
                  </li>
...
$qborrow1 = $link->query("select id_peliculas, tit_peliculas, sip_peliculas, ima_peliculas, ano_peliculas FROM peliculas ORDER BY id_peliculas desc") or die(mysqli_error());
while($fborrow1 = $qborrow1->fetch_array()){

$tlogf = strlen($fborrow1['id_peliculas']);
              ...
              <div class="card-body">
                <div class="d-flex px-3">
                  ...
                  <div class="pl-4">
                    ...
                    <p><?php echo $fborrow1['sip_peliculas']?></p>

                  </div>
                </div>

                  <p class="mt-12 mb-0 text-muted text-sm" align="right">
                    <span class="<?php echo $txtc; ?> mr-2"><i class="fas fa-arrow-up"></i></span>
...
$qborrow2 = $link->query("select id_usuario, nom_usuario, nickname, cla_usuario, ema_usuario, ava_usuario, ima_usuario, fec_usuario, hor_usuario FROM usuario ORDER BY id_usuario desc") or die(mysqli_error());
...
$txtc1 = "text-success";
$icof1 = "ni-satisfied";
$bico1 = "bg-gradient-success";
} else {
$tipc = "w";
$txtc1 = "text-warning";
$icof1 = "ni-active-40";
$bico1 = "bg-gradient-warning";
}	
...
<div class="row" align="center">
          <div class="col-md-12 col-lg-6 mb-5 mb-lg-0">
            <div class="px-4">
              ...
              <img src="images/<?php echo $fborrow2['ava_participante']?>" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 200px;">
          ...
          <div class="col-md-12 col-lg-6 mb-5 mb-lg-0">
            <div class="px-4">
				...
				<h4 class="title">
                  <span class="d-block mb-1"><?php echo $fborrow2['nom_usuario']?> </span>
                  <small class="h5 text-muted"><?php echo $fborrow2['nickname']?></small>
                </h4>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2019 <a href="https://www.cinecalidad.to" class="font-weight-bold ml-1" target="_blank">CINECALIDAD</a>
            </div>
          </div>
          <div class="col-xl-6">
