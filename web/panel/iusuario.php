...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="iusuario.php">Registro Usuario</a>
        <!-- Form -->
...
<div class = "col-lg-12 well" style = "margin-top:10px;">
						...
						<table id = "table" class = "table table-bordered table-hover">
							...
							<tbody>
								<?php
									...
									$qbook = $link->query("select id_usuario, nom_usuario, nickname, cla_usuario, ema_usuario, ava_usuario, ima_usuario, fec_usuario, hor_usuario from usuario") or die(mysqli_error());
									while($fbook = $qbook->fetch_array()){
										
								?>
								<tr>
									<td><?php echo $fbook['nom_usuario']?></td>
									<td><?php echo $fbook['nickname']?></td>
									<td><?php echo $fbook['ema_usuario']?></td>
									<td>
									<button id = "delbook_id" type = "button" class = "btn btn-danger delbook_id" value="<?php echo $fbook['id_usuario']?>"> Eliminar</button>
									
									<button id = "ebook_id" type = "button" class = "btn btn-warning ebook_id" value="<?php echo $fbook['id_usuario']?>">Editar</button>
					...
					<div id = "book_form" style = "display:none;">
						...
						<div class = "form-group col-lg-6">
							...
							<form method = "POST" name="fcalen" id="fcalen" action = "save_usuar_query.php" enctype = "multipart/form-data">
								<div class = "form-group col-lg-6">
									<label>Nombre Usuario:</label>
									<input type = "text" name = "nom_usuario" class = "form-control is-valid" />
								</div>
								<div class = "form-group col-lg-6">
									<label>Nickname Usuario:</label>
									
									<input type = "text" name = "nickname" class = "form-control is-valid" />
								...
								<div class = "form-group col-lg-4">
									...
									<input type="password" name = "cla_usuario" class = "form-control is-valid" />
								...
								<div class = "form-group col-lg-6">
									...
									<input type = "text" name = "ema_usuario" class = "form-control" />						
            ...
            <div class="input-group">
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        Examinar <input type="file" name="archivo1" style="display: none;" multiple>
                    </span>
                </label>
                <input type="text" class="form-control" readonly>
            </div>	
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.delbook_id').click(function(){
				...
				setTimeout(function(){
					window.location = 'delete_usuar.php?book_id=' + $book_id;
				}, 1000);
			});
			$('.ebook_id').click(function(){
				...
				$('#book_table').fadeOut();
				$('#add_book').hide();
				$('#edit_form').load('load_usuar.php?book_id=' + $book_id);
			});
		});
	</script>	
