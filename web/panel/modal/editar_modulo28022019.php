...
<form id="formEditar" data-smk-icon="glyphicon-remove" action="javascript:()">
...
<div class="pl-lg-4">
	  ...
	  <input class="form-control" type="text" id="id_pregmodul" name="id_pregmodul" value="<?php echo $id_pregmodul; ?>">
...
<br>			  	  
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" id="btnEditar">Procesar / Continuar</button>
      </div>
    </div>
	</form>
  </div>
